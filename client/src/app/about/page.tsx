          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Multiple payment options with secure payment gateways and cash on delivery.</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              <Truck className="h-8 w-8 text-green-600 flex-shrink-0" />
              <div>
                <h3 className="font-semibold text-xl mb-2">Reliable Delivery</h3>
                <p className="text-gray-600">Track your orders in real-time with our efficient delivery system.</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Rigorous quality checks to ensure the best produce reaches you.</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Dedicated support team to assist both farmers and consumers.</p>
              </div>
            </div>
          </div>
        </div>
